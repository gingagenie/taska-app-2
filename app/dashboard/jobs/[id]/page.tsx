...
export default function JobPage() {
  ...
  // TS-safe param extraction (handles null and string[])
  const params = useParams<RouteParams>() as Partial<Record<'id', string | string[]>> | null;
  ...
  if (!jobId) return <main style={{ padding: 24 }}><p>Missing job id.</p></main>;
  if (err) return <main style={{ padding: 24 }}><p style={{ color: 'crimson' }}>Error: {err}</p></main>;
  if (!job) return <main style={{ padding: 24 }}><p>Loading…</p></main>;
